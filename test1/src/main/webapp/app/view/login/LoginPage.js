Ext.define('Test1.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Test1.view.login.LoginPageController',
	             // 'Test1.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Test1.view.main.MainPanel' ],
