Ext.define('Test1.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Test1.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
