Ext.define('Test1.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Test1.view.querybuildernewmodel.querycondition.QuerySelectController',
