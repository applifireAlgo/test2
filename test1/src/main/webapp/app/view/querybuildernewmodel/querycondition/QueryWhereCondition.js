Ext.define('Test1.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Test1.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
