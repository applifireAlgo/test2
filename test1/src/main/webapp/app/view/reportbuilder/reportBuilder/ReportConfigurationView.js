Ext.define('Test1.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Test1.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Test1.view.reportbuilder.gridconfig.GridConfigView',
	           'Test1.view.reportbuilder.properties.PropertiesPanelView',
	           'Test1.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
