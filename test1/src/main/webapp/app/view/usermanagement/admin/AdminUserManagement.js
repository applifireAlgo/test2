Ext.define('Test1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Test1.view.usermanagement.admin.UserPasswordReset',
	            'Test1.view.usermanagement.admin.AddUserDetails',
	            'Test1.view.usermanagement.admin.ViewUser'],
