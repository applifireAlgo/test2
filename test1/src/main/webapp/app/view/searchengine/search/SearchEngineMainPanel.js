Ext.define('Test1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	//alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Test1.view.searchengine.search.NorthPanel', 'Test1.view.searchengine.search.SearchResult','Test1.view.searchengine.search.SearchEngineMainPanelController'],
