Ext
		.define(
				'Test1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Test1.view.searchengine.search.SearchEngineMainPanelController','Test1.view.searchengine.search.PanelHeaderField' ,'Test1.view.searchengine.search.ReportGridView','Test1.view.searchengine.search.ReportChartView','Test1.view.searchengine.search.documentView','Test1.view.searchengine.search.DouMeanView','Test1.view.googlemaps.map.MapPanel'],
