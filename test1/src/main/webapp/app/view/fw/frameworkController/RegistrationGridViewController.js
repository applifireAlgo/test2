Ext.define('Test1.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Test1.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Test1.view.console.ConsoleWindow');
