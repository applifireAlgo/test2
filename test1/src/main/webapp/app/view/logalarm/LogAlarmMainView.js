 ...
 * 
 */
Ext.define('Test1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Test1.view.logalarm.LogAlarmMainViewController',
			'Test1.view.logalarm.tree.LogAlarmTreePanel',
			'Test1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
