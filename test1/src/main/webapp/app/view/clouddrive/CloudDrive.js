Ext.define("Test1.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Test1.view.clouddrive.CloudDriveController',
	             'Test1.view.clouddrive.documentview.DocumentsView',
	             'Test1.view.clouddrive.drivedetails.DriveDetails',
	             //'Test1.view.clouddrive.documentview.DocumentListView'
	             ],
