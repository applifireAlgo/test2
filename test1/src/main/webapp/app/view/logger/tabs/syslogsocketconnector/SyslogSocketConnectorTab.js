 ...
 * 
 */
Ext.define('Test1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Test1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
