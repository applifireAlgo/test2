Ext.define('Test1.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Test1.view.reportui.datachart.chart.RatingField','Test1.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
