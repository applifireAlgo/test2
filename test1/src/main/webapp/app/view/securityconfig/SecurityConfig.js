 ...
 * 
 */
Ext.define('Test1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Test1.view.securityconfig.SecurityConfigController',
			'Test1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
