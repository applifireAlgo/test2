...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("3x6a2j5gy0a4IWRzcEkPRPoH8bNFwUx8eDb9qOYWzKpufbFcWf");
            ...
            appcustomertype.setCustomerType("jDfDPvcgxeY98RuoL8Sb2Q2wXH0XL40QBjmbCTKZwKv1D28H6w");
            ...
            corecontacts.setEmailId("x5zj4QUVdpC9JNxr8jeSzeCVUBRjsTWIjrOpWQINNVUN4oXDBa");
            corecontacts.setFirstName("X3g0IiwnSDZOJv6I5nX7SL8ctWsuvV6xPuTWYOd1Bd1FOJOX1W");
            Gender gender = new Gender();
            gender.setGender("NlGDi07TgIurxAHQ39NPeumlddWtYF8llcMjlcSK3MxGRP0ZXp");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("Ua");
            language.setAlpha3("wxb");
            language.setAlpha4("oZPT");
            language.setAlpha4parentid(3);
            language.setLanguage("9Od8rllf1qIUxwI2YvhhxZbNGW5qZTeW2VJ1PkqNYB0Ml4yXfW");
            language.setLanguageDescription("D5gApOGLPxhIDdNnHH3su38eLrsOelcMMKWHCXHK3J0pqUYy9V");
            language.setLanguageIcon("wH806H1m6EPRfpQHRsAPQ8bfg6c3OxoSeDVCt5DcnCQ01QXSuY");
            language.setLanguageType("R3pV7vjzpoItjYi4pE8oUupzxMysDp9M");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("FX4uuxD6xpCAPKktUpyCUBLP0w5ySzUmmMANjPagHVeNPd5BVu");
            timezone.setCountry("SOLE9LXIiW2NSYh6KN2B04Zb4XCMi1PqCgfsgVGZOK750lhzCn");
            timezone.setGmtLabel("fDdlQ6TRgwxRUwxbTKo9zclgzOibjitYnhJ8bcuu9UYlNt1fPY");
            timezone.setTimeZoneLabel("uydz85YRwCdaOIY82LJTKs6ytcTF07Qg7lNlmDBKDIXj9yZbGh");
            timezone.setUtcdifference(6);
            Title title = new Title();
            title.setTitles("dMnah8UmBWpCmM6wCe4yKh7NkeR6lGMADAaaoRw4497t3LP2J1");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(77);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("E4fjrPSr296ADVEoVUQe4mtKZOXsU6vUcZZaKXKwP51pnxiQDN");
            corecontacts.setFirstName("zgpGUMTByESqBm87geu5uPANvyg8POcDKTg8n1hwK3vA7HBuwD");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("yto5YuJmHZzaJXAHBNCU68H9nOEiyQqTaPD9ET5Jc6Hy14dHcG");
            corecontacts.setMiddleName("P8hr1qJxWqjTx5SxMMykEXK8wS3VtFc9JuFTrSVGtssISqJseG");
            corecontacts.setNativeFirstName("9BA3Yw3ihsCKvVguAhe1gUrTOMGId9tmyr5wUtsY3OGmrzJ7Gd");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("svf3Xwy6zIKwfSjytCYvFdMyOsyD5W6UJElegbVf6ZfkxSntmW");
            corecontacts.setNativeMiddleName("edfG9vj4d40bV2XroP67DIzEyQ1oUtdSMYO8a0qegG5B8ey832");
            corecontacts.setNativeTitle("lQzQemIFYTUgko8LcG5GRHl3IBPFqzcqaq6Bzjc77BFGX8M0mf");
            corecontacts.setPhoneNumber("PXEb7bkY8epsIImm1nZf");
            ...
            appcustomer.setCustomerName("T5n9Abaa51l5BbW4MprZ8OyVcTvqGlqvZKC3yfmNRwmly6zyjY");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("s22UyojDLr7j6KUa7DM3RN0YqwauwIIGfXkwSqeAvSPfcDbZ5n");
            appcustomer.setCustomerStatus(0);
            appcustomer.setEvalTimePeriod(2147483647);
            appcustomer.setUserRequested(2147483647);
