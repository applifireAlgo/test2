...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("s19K9fSXYut1reKU9eCxgyaCm4gzbY1D");
            country.setCapitalLatitude(7);
            country.setCapitalLongitude(10);
            country.setCountryCode1("Cmh");
            country.setCountryCode2("Al8");
            country.setCountryFlag("EfXYsrYIfA6oVspbD5Vz1qhW7d09TYEoVmTqeE3vxm10ovV6uv");
            country.setCountryName("02cLnWqh2xLwNQliQhmKE0eDu3yoBMRGvlITRdC2jeW8LrDkma");
            country.setCurrencyCode("o0z");
            country.setCurrencyName("tUhQ5eDP7Pgi9eq6gh6tts5KM6v2ntzuHh85n5xmEEDs9Szx0P");
            country.setCurrencySymbol("NCy7hXyuQwZA1B2SgVV5HJZx5WrHLmOB");
            country.setIsoNumeric(5);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("WlPzX7yPvLlKLgpfG1qBD62DY75BKmr3UMHB9lRF1LzGlnS8R3");
            currency.setUnicodeDecimal("YmJdsv2o94iuET3nwP2xpPJEdeK5qDz9UxFPRNPUHAMj14npNC");
            currency.setUnicodeHex("TmhFwcBlNgie4a7npAFoja9pBrtEKSeqM1JcRPj4Ei7qtanW1S");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("9QqytUMxGotaj424eKT4METMKXBPwLEf87V7fDtUlAL3YfdS4R");
            currency.setUnicodeDecimal("VYnibvit4imflZFJWMHHUskxS6190EMaGXSwRbCeaz3X4KpjLv");
            currency.setUnicodeHex("SJcDUSWH8Hlycmlau7l5R4pI9Azq87beGNuilfQglU2RXhUIOE");
